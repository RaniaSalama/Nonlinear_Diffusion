...
sigma_cora = np.loadtxt( 'sigma_change_cora_tanh.txt', delimiter=',')
plt.plot(sigma_cora[:,0], sigma_cora[:,1], '--r', label='Cora', linewidth=10, markersize=10)

sigma_citeseer = np.loadtxt( 'sigma_change_citeseer_tanh.txt', delimiter=',')
...
sigma_pubmed = np.loadtxt( 'sigma_change_pubmed_tanh.txt', delimiter=',')
