...
function run_nnlinear_diffusion{T}(A::SparseMatrixCSC{T,Int64}, L::SparseMatrixCSC{T,Int64}, pinvD::SparseMatrixCSC{T,Int64}, h::Float64, seed::Int64, t::Float64, p::Float64, truncCutoff::Float64)
    n = size(A, 1)
